...
<div class="topnav">
    ...
    <a class="active" href="/student">Studenti</a>
...
<table border="1" id="myTable" >
    ...
    <c:forEach var="student" items="${listStudent}">
        ...
        <tr>
            <td><c:out value="${student.codst}" /></td>
            <td><c:out value="${student.nume}" /></td>
            <td><c:out value="${student.prenume}" /></td>
            <td><c:out value="${student.cetatenie}" /></td>
            <td><c:out value="${student.datan}" /></td>
        </tr>
    </c:forEach>
